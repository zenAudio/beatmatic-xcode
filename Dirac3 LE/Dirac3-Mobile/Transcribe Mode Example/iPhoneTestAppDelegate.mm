...
//
//	ABSTRACT:
//	Demonstrates Dirac's Transcribe Mode for extreme time stretch settings (offline processing)
//
//  iPhoneTestAppDelegate.m
//  iPhoneTest
//
//  Created by Stephan on 05.10.09.
//  Copyright The DSP Dimension 2009-2012. All rights reserved.
//
...
-(void)processThread:(id)param
{
	...
	[version setText:[NSString stringWithFormat:@"TranscribeMode Example\nDIRAC Version: %s", DiracVersion()]];
	...
	void *dirac = DiracCreate(kDiracLambdaTranscribe, kDiracQualityGood, numChannels, sampleRate, &myReadData, (void*)self);
...
{    
	NSString *inputSound  = [[[NSBundle mainBundle] pathForResource:  @"song" ofType: @"aif"] retain];
